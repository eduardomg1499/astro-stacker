...
export const SOLAR_CURVE_PRESETS = Object.freeze({
  ...
  prominence: {
    ...
    invert: false,
    colorize: true,
    curvePoints: [[0, 0], [0.035, 0.022], [0.14, 0.2], [0.55, 0.66], [0.9, 0.9], [1, 1]],
    shadowColor: "#090000",
    midtoneColor: "#9e1600",
    highlightColor: "#ffd35a",
    colorStrength: 0.95,
    highlightProtect: 0.88,
    backgroundProtect: 0.94,
    prominenceAmount: 0.72,
    filamentAmount: 0.18,
    filamentRadius: 1.3,
    noiseGuard: 0.82,
  },
